...
import com.sinothk.ali.pay.util.OrderInfoUtil2_0;

import java.util.Map;

public class AliPayDemoMainActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ali_pay_demo_main);
    }
